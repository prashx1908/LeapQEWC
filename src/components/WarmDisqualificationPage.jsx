  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 0 }}>
      <div style={{ maxWidth: 400, width: '100%', background: '#fff', borderRadius: 22, boxShadow: '0 4px 18px rgba(74,144,226,0.10)', padding: '32px 20px 24px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '48px auto 0 auto', position: 'relative', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 800, color: '#4A90E2', marginBottom: 10 }}>Thank you!</h2>
        {isBoth ? (
          <>
            ...
            <div style={{ color: '#4A90E2', fontWeight: 600, fontSize: 14, marginBottom: 10, marginTop: 8 }}>Resources for you:</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, width: '100%', marginBottom: 18 }}>
              <a href="https://portal2.passportindia.gov.in/" target="_blank" rel="noopener noreferrer" style={{ background: '#f8f6f3', borderRadius: 10, padding: '10px 12px', boxShadow: '0 1px 4px #4A90E211', textAlign: 'left', color: '#4A90E2', textDecoration: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8, fontSize: 15 }}>
                <span style={{ fontSize: 18 }}>🛂</span> Passport Application Portal
              </a>
              <a href="https://leapscholar.com/ebook" target="_blank" rel="noopener noreferrer" style={{ background: '#f8f6f3', borderRadius: 10, padding: '10px 12px', boxShadow: '0 1px 4px #4A90E211', textAlign: 'left', color: '#4A90E2', textDecoration: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8, fontSize: 15 }}>
                <span style={{ fontSize: 18 }}>📘</span> Roadmap to Studying Abroad
              </a>
              <a href="https://leapscholar.com/blog/mbbs-to-pg-abroad" target="_blank" rel="noopener noreferrer" style={{ background: '#f8f6f3', borderRadius: 10, padding: '10px 12px', boxShadow: '0 1px 4px #4A90E211', textAlign: 'left', color: '#4A90E2', textDecoration: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8, fontSize: 15 }}>
                <span style={{ fontSize: 18 }}>🗓️</span> MBBS → PG Abroad Pathways
              </a>
              <a href="https://leapscholar.com/blog" target="_blank" rel="noopener noreferrer" style={{ background: '#f8f6f3', borderRadius: 10, padding: '10px 12px', boxShadow: '0 1px 4px #4A90E211', textAlign: 'left', color: '#4A90E2', textDecoration: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8, fontSize: 15 }}>
          ...
          <>
            ...
            <div style={{ color: '#4A90E2', fontWeight: 600, fontSize: 14, marginBottom: 10, marginTop: 8 }}>Free guides for you:</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, width: '100%', marginBottom: 18 }}>
              <a href="https://leapscholar.com/ebook" target="_blank" rel="noopener noreferrer" style={{ background: '#f8f6f3', borderRadius: 10, padding: '10px 12px', boxShadow: '0 1px 4px #4A90E211', textAlign: 'left', color: '#4A90E2', textDecoration: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8, fontSize: 15 }}>
                <span style={{ fontSize: 18 }}>📘</span> Roadmap to Studying Abroad
              </a>
        ...
        <div style={{ width: '100%', background: 'rgba(74,144,226,0.07)', borderRadius: 12, padding: '12px 10px', margin: '0 0 8px 0', display: 'flex', alignItems: 'center', gap: 10, boxShadow: '0 1px 4px rgba(74,144,226,0.06)' }}>
          <img src="https://ik.imagekit.io/onsnhxjshmp/LeapScholar/new-header-logo_7i5sVUf9VF.svg" alt="Leap Scholar" style={{ height: 28, marginRight: 8, borderRadius: 6, background: '#fff', padding: 2 }} />
          <div style={{ textAlign: 'left', fontSize: 13, color: '#4A90E2' }}>
